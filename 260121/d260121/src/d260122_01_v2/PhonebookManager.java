...
public class PhonebookManager {
    private final Phonebook[] pb = new Phonebook[100];
    private int index = 0;
...
//                return BeanUtils.copyProperties(); //spring 객체
            }
        }
        return null;
    }

    public Phonebook getPhonebookByName(String searchname) {
        return null;
    }
