...
//        PhoneBook 객체
//        전화번호 객체는 데이터를 한 번에 담는 그릇이다.
//        전화번호 객체는 데이터를 한 번에 전송하는 객체이다.
//        생성자 함수는 여러개가 가능하다.
//        생성자, get, set, toString 함수 작성

//        Manager 객체
//        전화번호 객체를 관리하는 객체는 입력, 출력, 수정, 삭제의 기능을 가지고 있다.
//        추가적으로 관리하는 개체는 여러 개의 전화번호가 있어야 한다.

//        PhoneBookMain 객체
//        전화번호 객체와 전화번호 관리 객체를 실행하는 함수는 main 함수이다.
